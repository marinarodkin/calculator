...
describe('Calculator', () => {
  ...
  describe('updateDisplay', () => {
    ...
    beforeEach(() => wrapper = shallow(<Calculator />));
    // ***************
    it('after an operator start a new number', () => {
    ...
    // ***************
    it('decimal point creates decimal', () => {
      wrapper.instance().updateDisplay('5');
    ...
    it('adding two decimals', () => {
      ...
      expect(wrapper.state('displayValue')).toEqual('8.8');
    });
    ...
    //*****
    it('updates displayValue make clean after showing result', () => {
      wrapper.setState({ storedValue: '3.34' });
      wrapper.setState({ displayValue: '2.25' });
  ...
  describe('setOperator', () => {
    ...
    */
    it('after setting operator displayValue does not change', () => {
      wrapper.setState({ displayValue: '5' });
      wrapper.instance().setOperator('+');
      expect(wrapper.state('displayValue')).toEqual('5');
    });
  ...
  describe('callOperator', () => {
    ...
    it('updates displayValue to the sum of multi-digit numbers', () => {
      wrapper.setState({ storedValue: '342' });
      wrapper.setState({ displayValue: '252' });
      wrapper.setState({ selectedOperator: '+' });
      wrapper.instance().callOperator();
      expect(wrapper.state('displayValue')).toEqual('594');
    });
    it(' number too large', () => {
      wrapper.setState({ storedValue: '3000000' });
      wrapper.setState({ displayValue: '2000000' });
      wrapper.setState({ selectedOperator: '*' });
      wrapper.instance().callOperator();
      expect(wrapper.state('displayValue')).toEqual('too large');
    });
    ...
    //******
    it('updates displayValue to the product of storedValue and displayValue with decimals', () => {
      wrapper.setState({ storedValue: '3.34' });
      wrapper.setState({ displayValue: '2.25' });
      wrapper.setState({ selectedOperator: '+' });
      wrapper.instance().callOperator();
      expect(wrapper.state('displayValue')).toEqual('5.59');
    });
